 ...
 */
class mod_certificate_renderer extends plugin_renderer_base {
    ...
    function export_buttons($cm) {
        ...
        $btndownloadods = $OUTPUT->single_button(new moodle_url('/mod/certificate/report.php', array('id' => $cm->id, 'download' => 'ods')), get_string('downloadods'));
        $btndownloadxls = $OUTPUT->single_button(new moodle_url('/mod/certificate/report.php', array('id' => $cm->id, 'download' => 'xls')), get_string('downloadexcel'));
        $btndownloadtxt = $OUTPUT->single_button(new moodle_url('/mod/certificate/report.php', array('id' => $cm->id, 'download' => 'txt')), get_string('downloadtext'));

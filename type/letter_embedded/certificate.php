...
if ($printconfig->printhours) {
    certificate_print_text($pdf, $x, $y + 339, 'C', 'freeserif', '', 10, get_string('credithours', 'certificate') . ': ' . $printconfig->printhours);
}

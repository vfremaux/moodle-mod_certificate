...
$string['certificate:printteacher'] = 'Est mentionné sur l\'attestation comme formateur';
$string['certificate:isauthority'] = 'Est autorité de certification';
$string['certificate:getown'] = 'Retirer sa propre attestation';
$string['certificate:apply'] = 'Peut obtenir une attestation';
$string['certificate:deletecertificates'] = 'Peut détruire des attestations';
...
$string['certificatetype'] = 'Modèle d\'attestation';
$string['certificateverification'] = 'Vérification de l\'attestation';
$string['certificateverifiedstate'] = 'Le code d\'attestation que vous avez demandé est reconnu et correspond à l\'enregistrment ci-dessous :';
...
$string['gettestcertificate'] = 'Tester le retrait d\'attestation';
...
$string['printcode_help'] = 'Un code unique à 10 caractères alphanumériques est imprimé sur l\'attestation. Ce numéro permet une vérification de la validité d\'une attestation.';
...
$string['printteacher_help'] = 'Les instructeurs qui seront affichés sur l\'attestation doivent avoir un rôle d\'enseignant dans le contexte du module lui-même. Vous pouvez ainsi avoir plusieurs attestations dans le même cours délivrées au nom d\'enseignants différents. Pour cela éditez les rôles locaux dans l\'administration du module et assignez le rôle Enseignant Editeur. Les enseignants mentionnés ici n\'ont pas nécessairement à avoir un rôle d\'enseignant dans le cours lui-même.';

...
function getlayout(id) {
    ...
    layoutobj.x = parseInt($(id).css('left').replace('px', '')) - parseInt($('#mod-certificate-builder').css('left').replace('px', ''));
    layoutobj.x = parseInt($(id).css('top').replace('px', '')) - parseInt($('#mod-certificate-builder').css('top').replace('px', ''));
